...
for (const name of ['worker.js', 'planner.js', 'flows.js', 'goals.js', 'startup.js', 'capacity.js', 'boiler.js', 'catalog.js', 'configuration.js', 'reconstruct.js']) await copyFile(`kernel/${name}`, `${destination}/kernel/${name}`);
