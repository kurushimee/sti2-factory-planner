...
RECIPE_FIELDS = set("id source_id type origin name primary inputs outputs configurations group conditions catalysts expected_yields yield_range process requires_obtained replication crafting_evidence assumptions tool_usage unsupported".split())
